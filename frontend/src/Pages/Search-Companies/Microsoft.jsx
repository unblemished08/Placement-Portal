  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg max-w-xl w-full hover:scale-105 transition-transform">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-800">Microsoft</h2>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-start">
          ...
          <span className="ml-2 text-gray-800">₹60 LPA</span>
        </div>
        <div className="flex items-start">
        ...
        <div className="flex items-start">
          ...
          <span className="ml-2 text-gray-800">10</span>
        </div>
        <div className="flex items-start">
          <span className="font-semibold text-gray-600">CGPA Required:</span>
          <span className="ml-2 text-gray-800">8.5</span>
        </div>
        <div className="flex items-start">
        ...
        <div className="flex items-start">
          ...
          <span className="ml-2 text-gray-800">CSE, IT, ECE</span>
        </div>
      </div>
    </div>
  );
