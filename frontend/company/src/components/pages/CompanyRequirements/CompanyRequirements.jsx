                ...
                <form onSubmit={handleSubmit} className="space-y-6 w-3/4 bg-slate-50 shadow-gray-500 rounded-lg p-6 hover:shadow-lg hover:shadow-gray-600 transition-shadow duration-300">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col">
                            {edit === false ? (
                                <p className="font-medium text-gray-700">
                                    <strong>CTC/Stipend:</strong> {data.ctc}
                                </p>
                            ) : (
                                <div>
                        ...
                        <div className='flex flex-col'>
                            {edit === false ?
                                <p className="font-medium text-gray-700"><strong>Is Online Assessment  :</strong> {data.OA}</p>
                                : <div>
                                    <label htmlFor="OA" className="block font-semibold text-gray-800 mb-1">Is Online Assessment:</label>
                                    {
                                        edit === false
                                            ? <p className="font-medium text-gray-700">{data.OA}</p>
                                            : <select
                                                value={data.OA}
                                                name="OA"
                                                id="OA"
                        ...
                        <div className='flex flex-col'>
                            {edit === false ?
                                <p className="font-medium text-gray-700"><strong>Is Aptitude Round :</strong> {data.aptitude}</p>
                                : <div>
                                    <label htmlFor="aptitude" className="block font-semibold text-gray-800 mb-1">Is Aptitude Round:</label>
                                    {
                                        edit === false
                                            ? <p className="font-medium text-gray-700">{data.aptitude}</p>
                                            : <select
                                                value={data.aptitude}
                                                name="aptitude"
                                                id="aptitude"
                            ...
                            {edit === false ? (
                                ...
                                <div>
                                    ...
                                    <div className="w-full px-3 py-2 border rounded border-gray-400 ">
                                        {["Full Time", "Intern + Full Time", "Intern", "Research Intern/Project"].map((profile) => (
                        ...
                        <div className="flex flex-col">
                            {edit === false ? (
                                ...
                                <div>
                                    <label htmlFor="description" className="block font-semibold text-gray-800 mb-1">Description:</label>
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        rows={5}
                                        className="w-full px-3 py-2 border rounded border-gray-400 resize-none"
                                    />
                                </div>
                            )}
                        </div>
